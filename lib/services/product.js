...
const deleteProduct = (id, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let imagePath = path_1.default.join(__dirname, "../../public/", product.image.split(`${env_1.default.FILE_HOST}`)[1].replace('Weekly ', 'Weekly\ '));
    //  console.log("Product image: ", product.image, "Env Secret: ", envsecret.FILE_HOST)
    try {
        fs_1.default.unlinkSync(imagePath);
    }
    catch (error) {
        imagePath = path_1.default.join(__dirname, "../public/", product.image.split(`${env_1.default.FILE_HOST}`)[1].replace('Weekly ', 'Weekly\ '));
        fs_1.default.unlinkSync(imagePath);
    }
